document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    //
    // 1. Show the question
    // Update the inner text of the question container element and show the ;
    ...
    questionCount.innerText = `Question ${quiz.currentQuestionIndex} of ${questions.length}`; //  This value is hardcoded as a placeholder
  ...
  function nextButtonHandler() {
    ...
    if (selectedAnswer) {
      // console.log(`selected Answer insode if ${selectedAnswer}`);
